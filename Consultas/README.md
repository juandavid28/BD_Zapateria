...
![descendentemente_precio](descendentemente_precio.png "descendentemente_precio")

### 10. Obtener un listado completo de artículos, incluyendo por cada articulo los datos del artículo y de su fabricante.

![Articulo_datos_fabricante](articulo_datos_fabricante.png "Articulo_datos_fabricante")

### 11. Obtener un listado de articulos, incluyendo el nombre del articulo, su precio y el nombre de su fabricante.

![Articulo_precio_fabricante](articulo_precio_fabricante.png "Articulo_precio_fabricante")
...
![Fabricante_nombre](fabricante_nombre.png "Fabricante_nombre")

### 14. Obtener el nombre de los fabricantes que ofrezcan productos cuyo precio medio sea mayor o igual a 50000

![Nombre_producto_mayor_50000](nombre_producto_mayor_50000.png "Nombre_producto_mayor_50000")

### 15. Obtener el nombre y el precio del artículo mas barato.

![precio_articulo_barato](precio_articulo_barato.png "precio_articulo_barato")